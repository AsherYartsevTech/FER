...
def dense_cnn(inputs):
  ...
  model = Model(inputs, x, name='dense_cnn')
  return model
...
if __name__ == "__main__":
  ...
  _ = compile_and_train(dense_cnn_model, 200, train_dataset, train_labels, valid_dataset, valid_labels)

  test_loss, test_acc = dense_cnn_model.evaluate(test_dataset, test_labels)
